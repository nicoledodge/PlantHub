...
//   }
  ...
  Mutation: {
    addUser: async (parent, { firstName, lastName, username, email, password, location, experience }) => {
      const user = await User.create({ firstName, lastName,username, email, password, location, experience });
